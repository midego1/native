...
4. Run `zero-native automate resize ...`, `zero-native automate bridge '...'`, or write command-source actions to `command.txt`
5. Verify bridge responses, relayout bounds, and updated snapshots
